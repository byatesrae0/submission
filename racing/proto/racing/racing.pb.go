...
// Represents the Race status.
type Race_Status int32

const (
	// This is not a valid status.
	Race_RACE_STATUS_UNKNOWN Race_Status = 0
	Race_RACE_STATUS_OPEN    Race_Status = 1
	Race_RACE_STATUS_CLOSED  Race_Status = 2
)
...
type ListRacesRequest struct {
	...
	// Order by any single field in Race.
	// Expected to be in the format "field [ASC|DESC]"
	// Examples:
	//  advertised_start_time DESC
	//  meeting_id
...
type ListRacesRequestFilter struct {
	...
	// When true only races that are visible are returned.
	VisibileOnly bool `protobuf:"varint,2,opt,name=visibile_only,json=visibileOnly,proto3" json:"visibile_only,omitempty"`
}
...
func (x *ListRacesRequestFilter) GetVisibileOnly() bool {
	if x != nil {
		return x.VisibileOnly
	}
	return false
}
...
func (x *Race) GetStatus() Race_Status {
	...
	return Race_RACE_STATUS_UNKNOWN
}
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x52, 0x05, 0x72, 0x61, 0x63, 0x65, 0x73, 0x22, 0x5e,
	...
	0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x76, 0x69, 0x73,
	0x69, 0x62, 0x69, 0x6c, 0x65, 0x5f, 0x6f, 0x6e, 0x6c, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x0c, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x65, 0x4f, 0x6e, 0x6c, 0x79, 0x22, 0x20,
	0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52, 0x61, 0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64,
	0x22, 0xc9, 0x02, 0x0a, 0x04, 0x52, 0x61, 0x63, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	0x74, 0x61, 0x74, 0x75, 0x73, 0x12, 0x17, 0x0a, 0x13, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x54,
	0x41, 0x54, 0x55, 0x53, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10, 0x00, 0x12, 0x14,
	0x0a, 0x10, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x4f, 0x50,
	0x45, 0x4e, 0x10, 0x01, 0x12, 0x16, 0x0a, 0x12, 0x52, 0x41, 0x43, 0x45, 0x5f, 0x53, 0x54, 0x41,
	0x54, 0x55, 0x53, 0x5f, 0x43, 0x4c, 0x4f, 0x53, 0x45, 0x44, 0x10, 0x02, 0x32, 0x7f, 0x0a, 0x06,
	...
	0x72, 0x61, 0x63, 0x69, 0x6e, 0x67, 0x2e, 0x52, 0x61, 0x63, 0x65, 0x22, 0x00, 0x42, 0x09, 0x5a,
